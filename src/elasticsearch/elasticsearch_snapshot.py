#!/usr/bin/env python3
"""
Elasticsearch Snapshot Management Helper Functions

This module contains all the core snapshot management functions for
creating, restoring, and listing Elasticsearch snapshots. These functions
are used by the main FastMCP tools in elasticsearch_server.py.

Functions:
- create_snapshot_operation: Create a snapshot (backup) of Elasticsearch indices
- restore_snapshot_operation: Restore indices from an Elasticsearch snapshot  
- list_snapshots_operation: List all snapshots in an Elasticsearch repository
"""
...
async def create_snapshot_operation(
    snapshot_name: str,
    repository: str = "backup_repository",
...
async def restore_snapshot_operation(
    snapshot_name: str,
    repository: str = "backup_repository",
    indices: Optional[str] = None,
    ignore_unavailable: bool = True,
    ...
    index_settings: Optional[str] = None
) -> str:
...
async def list_snapshots_operation(
    repository: str = "backup_repository",
    verbose: bool = True
) -> str:
